...
Array.prototype.z=function(a){a&&(this[2]=a);return this[2]};Math.clamp=function(a,d,b){return Math.max(d,Math.min(b,a))};"abs ceil clamp floor max min round".split(" ").forEach(function(a){Array.prototype[a]=function(){var d=Array.from(arguments);return this.map(function(b,c,e){return Math[a].apply(null,[b].concat(d))})}});
